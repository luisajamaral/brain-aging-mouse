#!/usr/bin/env Rscript
library("reticulate")
#use_python("/mnt/tscc/lamaral/software/miniconda3/bin/python")
#use_python("/projects/ps-renlab/lamaral/software/miniconda3/envs/py3.6/lib/python3.6")
use_python("/mnt/silencer2/home/lamaral/software/miniconda3/envs/py3.6/bin/python3.6",required = T)
#reticulate::use_virtualenv("/mnt/silencer2/home/yangli/apps/anaconda3/envs/")
#reticulate::use_virtualenv("/mnt/silencer2/home/lamaral/software/miniconda3/envs/")
...
path_to_venv = "/mnt/silencer2/home/yangli/apps/anaconda3/envs/venv_scrublet/"
#========================#
#------ rmDoublets ------#
...
rmDoublets.default <- function(
  ...
  import_from_path("six", path = "/projects/ps-renlab/lamaral/software/miniconda3/envs/py3.6/lib/python3.6/site-packages/")
...
#  mat.use = as.data.frame(as.matrix(mat.use))
...
meta = x.sp@metaData
meta$cluster = x.sp@cluster
meta$umap.1 = x.sp@umap[,1]
meta$umap.2 = x.sp@umap[,2]
write.table(meta, file = paste(outF,".meta.txt", sep = ""), row.names = F, sep = "\t")
