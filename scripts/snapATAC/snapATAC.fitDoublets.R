#!/usr/bin/env Rscript
#meta = "../../analysis/by_sample.snapATAC/18mo_5E+6E_1/snapFiles/18mo_5E+6E_1.meta.txt"
#input = "../../analysis/by_sample.snapATAC/18mo_5E+6E_1/snapFiles/18mo_5E+6E_1.rmDoublets.txt"
#outF = "../../analysis/by_sample.snapATAC/18mo_5E+6E_1/snapFiles/18mo_5E+6E_1"
...
plotValue(
    ...
    seed.use=10,
    plot.nrow=4,
    plot.ncol=4, main = paste("Doublets:" ,table(out$predicted_doublets)["TRUE"], "| Passed: ", table(out$predicted_doublets)["FALSE"]),
    pdf.file.name=NULL,
    pdf.height=7,
    pdf.width=7
    );
